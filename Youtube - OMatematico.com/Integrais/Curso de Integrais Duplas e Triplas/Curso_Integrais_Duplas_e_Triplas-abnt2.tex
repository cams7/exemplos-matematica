...
\chapterprecis{Cálculo de integrais triplas.}\index{sinopse de capítulo}	
	...
	\section{Coordenadas esféricas}
		...
		\subsection{Aula 7}
			\input{Integrais_Triplas_Coodernadas_Esfericas_Aula7}	
	\section{Coordenadas cilíndricas}
		\subsection{Aula 1}
			\input{Integrais_Triplas_Coodernadas_Cilindricas_Aula1}		
		\subsection{Aula 2}
			\input{Integrais_Triplas_Coodernadas_Cilindricas_Aula2}	
		\subsection{Aula 3}
			\input{Integrais_Triplas_Coodernadas_Cilindricas_Aula3}
		\subsection{Aula 4}
			\input{Integrais_Triplas_Coodernadas_Cilindricas_Aula4}
		\subsection{Aula 5}
			\input{Integrais_Triplas_Coodernadas_Cilindricas_Aula5}
		\subsection{Aula 6}
			\input{Integrais_Triplas_Coodernadas_Cilindricas_Aula6}
		\subsection{Aula 7}
			\input{Integrais_Triplas_Coodernadas_Cilindricas_Aula7}
		\subsection{Aula 8}
			\input{Integrais_Triplas_Coodernadas_Cilindricas_Aula8}
